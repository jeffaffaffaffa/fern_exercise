...
class CommentForm extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        //if no errors and done loading, clear body
    ...
    handleSubmit = (event) => {
        ...
        //submit the comment with its corresponding postId
    ...
    render() {
        ...
        const commentFormMarkup = authenticated ? (
            //return grid item bc the comment is already in a grid container
